...
public static class StockManagementAppEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE StockManagementAppModuleExtensionConfigurator CLASS (in the Domain.Shared project)
